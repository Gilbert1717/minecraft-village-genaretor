...
class House:
    ...
    def create_walls(self,mc):
        for floor in self.floors:
            ...
            create_blocks(mc, floor.frontleft, corner_one, rm.outline_blocks())
            ...
            create_blocks(mc, floor.frontright, corner_two, rm.outline_blocks())
            ...
            create_blocks(mc, floor.backleft, corner_three, rm.outline_blocks())
            ...
            create_blocks(mc, floor.backright, corner_four, rm.outline_blocks())
